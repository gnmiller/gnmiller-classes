...
//   DEC RISC systems.
//
//   DO NOT CHANGE -- part of machine emulation
//
...
//
//	This routine is reentrant, in that it can be called multiple
//	times concurrently -- one for each thread executing user code.
...
Machine::OneInstruction(Instruction *instr)
{
	...
	// ReadMem assumes all 4 byte requests are aligned on even 
